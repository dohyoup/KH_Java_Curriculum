...
public class Sample07 {
	...
	public static void main(String[] args) {
		 ...
		 * 		- 반복문은 기본적으로 조건식의 결과에 따라 반복을 진행하느냐 잰행하지 않느냐로 설정하지만
		 ...
		 * 		  생략 가능하며, 생략할 경우 반복문 외부에 미리 초기값을 설정해서 사용해야 한다.
		 * 
		 * 조건식 : 반복문 안의 코드 잰행 여부의 조건을 설정하기 위해 사용한다.
		 * 		  생략 가능하다. 단, 조건식을 생략하면 기본적으로 반복을 진행하는 것으로 동작하기 때문에 무한반복에 빠질수 있다.
		 * 		  반복문 내부에 별도의 if 조건문과 break 를 작성하여 종료 조건을 반드시 생성해야 한다.
		 * 		  조건식의 설정도 잘못 설정하는 경우 무한반복에 빠질수 있기 대문에 조건을 반드시 확인해야한다.
		 * 
