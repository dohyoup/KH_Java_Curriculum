...
<body>
	...
	<section class="container">
			...
			<div class="input-form inline">
				<div class="input-form">
					...
					<select class="select-form w-auto" name="jobId">
							<option value="${empsData.jobId}" selected>${empsData.jobName}</option>
					</select>
				</div>
				<div class="input-form">
			...
			<div class="input-form form-right">
				...
				<button class="btn btn-outline btn-ok" type="submit" onclick="ajaxEmpDelete(${empsData.empId});">삭제</button>
			</div>
		</div>
	</section>
</body>
